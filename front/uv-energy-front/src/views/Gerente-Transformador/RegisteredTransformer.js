...
class RegisteredElectricTransformer extends React.Component {
    constructor(props){
        ...
        this.RegisteredElectricTransformer = this.RegisteredElectricTransformer.bind(this);
    ...
    RegisteredElectricTransformer(e){
        e.preventDefault()
    ...
    render() {
        ...
        <UVHeader/>
            ...
            <Card className="bg-secondary shadow">
                    ...
                    <CardBody>
                    <Form onSubmit={this.RegisteredElectricTransformer}>
