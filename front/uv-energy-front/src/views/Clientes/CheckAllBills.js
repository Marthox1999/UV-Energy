...
class CheckAllBills extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            bill: {
    ...
    componentDidMount() {
        axios.get(c.api + 'sales/billList/', {
            params: { pk_cliente: this.state.credentials.id },
...
export default withTranslation()(CheckAllBills);